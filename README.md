<p align="center">
  <a href="https://paybill.dev" target="_blank">
    <picture>
      <img src="./static/aws-managed-grafana.png" alt="Banner" />
    </picture>
  </a>
</p>
...
This creates an Amazon Managed Grafana Workspace with
Amazon CloudWatch, AWS X-Ray and Amazon Managed Service for Prometheus
datasources

The authentication method chosen for this is with IAM Identity
Center (former SSO). You can extend this to add SAML.
